...
const PrincipalMessageSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="academy"
      className="relative w-full min-h-screen flex flex-col lg:flex-row overflow-hidden bg-[#F4F1EA]"
    >
      {/* Principal Image */}
      <div
        ref={imageRef}
        className="w-full lg:w-[52vw] h-[50vh] lg:h-auto relative will-change-transform"
        style={{ opacity: 0 }}
      >
        <img
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 py-12 lg:py-0">
        ...
        >
          ...
          <blockquote
            className="text-2xl sm:text-3xl lg:text-4xl text-[#0B1E2F] leading-snug mb-8"
